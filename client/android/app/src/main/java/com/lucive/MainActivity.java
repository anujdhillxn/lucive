...
public class MainActivity extends ReactActivity {
    ...
    protected ReactActivityDelegate createReactActivityDelegate() {
        return new ReactActivityDelegateWrapper(
                this,
                BuildConfig.IS_NEW_ARCHITECTURE_ENABLED, // Replaced direct architecture flag
                new DefaultReactActivityDelegate(
                        this,
                        getMainComponentName(),
                        BuildConfig.IS_NEW_ARCHITECTURE_ENABLED // Used the flag directly
                )
        );
    }
     ...
     * to the background instead of finishing activities.
